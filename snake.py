...
class Snake():
    ...
    def turn(self, direction):
        ...
        # Snake cannot make 100 degree turns unless it has only 1 position
    ...
    def move(self):
        ...
        #If the snake collided with itself (i.e. the new position was the same as one of its existing positions), reset the game
